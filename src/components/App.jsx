...
import Token from "../abis/HidethepainToken";
import TokenSale from "../abis/HidethepainTokenSale";
...
export default function App() {
	...
	const loadBlockchainData = async () => {
		...
		if (tokenData) {
			...
			window.alert("HideThePain Network not detected");
		}
		// Load HidethepainTokenSale
		...
		if (tokenSaleData) {
			...
			window.alert("HIDETHEPAIN TokenSale Network not detected");
		}
		setLoading(false);
	};
